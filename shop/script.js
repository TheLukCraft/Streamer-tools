document.addEventListener('DOMContentLoaded', function() {
    let commands = [
        { text: "!turtle żółwik dla widza (10pkt)", icon: "fas fa-hand-paper" },
        { text: "!leaf dostajesz z liścia (50pkt)", icon: "fas fa-leaf" },
        { text: "!rateme ocenka konta na op.gg (30pkt)", icon: "fas fa-chart-line" },
        { text: "!autograph podpis Steam (100pkt)", icon: "fas fa-signature" },
        { text: "!photo fotka z Tobą na DC (250pkt)", icon: "fas fa-camera" },
        ...
        { text: "!coaching analiza demka + porady (5k pkt)", icon: "fas fa-search" },
